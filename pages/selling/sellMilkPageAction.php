...
<body> 
    ...
    <table>
      ...
      <tr>
        <td>
          <?php echo $_POST["farmers_full_name"]; ?>
        </td>
        <td>
          <?php echo $_POST["farmers_phone_no"]; ?>
        </td>
        <td>
          <?php echo $_POST["milk_quantity"]; ?> Liters
        </td>
        <td>
          Ksh <?php echo $_POST["milk_cost_shillings"]; ?>
        </td>
        <td>
          <?php echo $_POST["milk_pickup_location"]; ?>
        </td>
        <td> 
          <a href="../buying/addedToCart.php">
